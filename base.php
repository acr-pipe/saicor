...
<html lang=\"es\">
  <head>
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"../assets/css/modulos/system_".$modulo.".css\">
  ...
  <body>
    ...
    <script src=\"../assets/js/modulos/system_".$modulo.".js\"></script>
  </body>
</html>";
			...
			echo "</div>";
			fopen("assets/css/modulos/system_".$modulo.".css", "w+");

			$nuevoarchivo = fopen("assets/js/modulos/system_".$modulo.".js", "w+");
