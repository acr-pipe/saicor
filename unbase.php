   ...
   <body>
     <?php 	
		if (!isset($_REQUEST['modulo'])) {
			...
			if (is_file("frames/control/ctr_".$modulo.".php")) 
				unlink("frames/control/ctr_".$modulo.".php");

			if (is_file("frames/model/m_".$modulo.".php")) 
				unlink("frames/model/m_".$modulo.".php");

			if (is_file("frames/view/v_".$modulo.".tpl")) 
				unlink("frames/view/v_".$modulo.".tpl");
