...
<html lang="es">
  ...
  <body>
  {$NAV}
  <input type="hidden" value="{$smarty.session.USR}" id="usr_session">
      ...
      <div class="large-2 medium-2 small-3 columns">
        <label><img src="../assets/img/zona_geo.svg" class="ico-gal">
          ...
          {section name=LE loop=$PROV}
            <option class="opt-gal" value="{$PROV[LE][0]}">{$PROV[LE][1]}</option>
          {/section}
          </select>
        </label>
      </div>
      ...
      <div class="large-2 medium-2 small-3 columns">
        <label><img src="../assets/img/estilo.svg" class="ico-gal">
          <select class="opt-gal" id="estilo">
            ...
            <option class="opt-gal" value="{$ESTILOS[LE][0]}" valor="{$ESTILOS[LE][1]}">{$ESTILOS[LE][1]}</option>
            {/section}
          </select>
        </label>
      </div>
        ...
        <label><img src="../assets/img/transmision.svg" class="ico-gal">
          <select class="opt-gal" id="transmision">
            ...
            {section name=LE loop=$TRANS}
              <option class="opt-gal" value="{$TRANS[LE][0]}">{$TRANS[LE][1]}</option>
            {/section}
          </select>
        </label>
      </div>
        ...
        <label><img src="../assets/img/combustible.svg" class="ico-gal">
         <select class="opt-gal" id="combustible">
            ...
            {section name=LE loop=$COMBUS}
              <option class="opt-gal" value="{$COMBUS[LE][0]}">{$COMBUS[LE][1]}</option>
            {/section}
          </select>
        </label>
      </div>
