<?php /* Smarty version 2.6.17, created on 2019-08-24 17:55:54
...
<div class="contain-to-grid fixed" style="opacity: 0.95">
  ...
  <section class="top-bar-section">
    ...
    <ul class="right">
      <?php if ($_SESSION['NOM']): ?>
      <li id="linomuser"><a href="#" data-options="align:left" data-dropdown="drop" class="tiny button nomuser"><?php echo $_SESSION['NOM']; ?>
</a></li>
      <?php else: ?>
