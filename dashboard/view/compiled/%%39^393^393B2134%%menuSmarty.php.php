<?php /* Smarty version 2.6.17, created on 2019-03-28 20:40:46
...
<header>
  <div class="contain-to-grid fixed" style="opacity: 0.95">
    ...
    <!-- Right Nav Section -->
      <ul class="right">
        <li id="linomuser">
          <a href="#" data-options="align:left" data-dropdown="drop" class="tiny button nomuser"><?php echo $_SESSION['NOM']; ?>
 <!-- <span class="badge">1</span> --></a>
        </li>
        <!-- <li><a href="logout"><?php echo $_SESSION['NOM']; ?>
</a></li> -->
