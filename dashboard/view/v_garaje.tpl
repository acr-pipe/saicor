...
<div class="row" id="myvehiculos">
  {section name=LE loop=$VEHI}
    <div class="large-1 medium-1 small-3 columns"><img src="{$VEHI[LE][0]}" class="pic-contain" enventa="{$VEHI[LE][1]}" id="v{$VEHI[LE][2]}" data-tooltip aria-haspopup="true" class="has-tip" title="{$VEHI[LE][3]} {$VEHI[LE][4]}<br>{$VEHI[LE][5]}<br>{$VEHI[LE][6]}"></div>
  {/section}
  {if $VEHI|@count eq 0}
  ...
  <div class="content bg-darkl2" id="panel-submenu4">
     ...
     <div class="row" align="center"><br>
      {section name=LE loop=$CAMBIO}
       <div class="large-2 medium-2 small-12 columns"><p id="preciocol-submenu"></p><abbr><p id="preciodol-submenu" title="Banco Central de Costa Rica: {$CAMBIO[LE][0]}"></p></abbr></div>
       <input type="hidden" id="tcambio" value="{$CAMBIO[LE][0]}">
       {/section}
